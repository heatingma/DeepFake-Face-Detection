...
from detection.metrics.registry import BACKBONE
...
class EfficientNetB4(nn.Module):
    def __init__(
        ...
        if pretrained is not None:
            self.efficientnet = EfficientNet.from_pretrained('efficientnet-b4',weights_path=pretrained)  # FIXME: load the pretrained weights from online
